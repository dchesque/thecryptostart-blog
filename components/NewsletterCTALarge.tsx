...
export default function NewsletterCTALarge({ className = '' }: NewsletterCTALargeProps) {
  return (
    <section
      id="newsletter"
      className={`relative bg-ink text-paper rounded-3xl overflow-hidden px-6 sm:px-12 py-16 md:py-24 ${className}`}
    >
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        <span className="inline-block text-[11px] font-bold tracking-[0.16em] uppercase text-paper/60">
          The Sunday Brief
        </span>
        <h2 className="mt-4 font-heading text-3xl md:text-5xl font-bold tracking-tight leading-[1.05] text-balance">
          The clearest read on crypto, in your inbox every Sunday.
        </h2>
        <p className="mt-6 text-lg text-paper/70 leading-relaxed max-w-xl mx-auto">
