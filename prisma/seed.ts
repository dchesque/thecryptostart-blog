...
async function main() {
    ...
    const postsToCreate = [
        ...
        },
        {
            ...
            slug: 'ethereum-2-future',
            excerpt: 'What the transition to Proof of Stake means for the Ethereum ecosystem.',
            content: 'Ethereum has successfully transitioned to Proof of Stake, significantly reducing its energy consumption and laying the groundwork for future scalability upgrades like sharding.',
            status: PostStatus.PUBLISHED as PostStatus,
            publishDate: new Date(Date.now() - 345600000), // 4 days ago
            featuredImageUrl: 'https://images.unsplash.com/photo-1622715091339-1ae446c24459?w=1200&h=630&fit=crop',
            featuredImageAlt: 'Ethereum logo digital',
            featuredImageWidth: 1200,
            featuredImageHeight: 630,
            contentType: ContentType.ARTICLE,
            difficulty: Difficulty.INTERMEDIATE,
            ...
            readingTime: 4,
            wordCount: 350,
            targetKeyword: 'ethereum 2.0',
            categorySlug: 'ethereum',
        },
        {
            title: 'Top 5 Crypto Wallets for 2026',
            slug: 'top-5-wallets-2026',
            excerpt: 'Our definitive list of the safest and most user-friendly wallets this year.',
            content: 'Choosing the right wallet is crucial. Here are our top picks: 1. Ledger Nano X, 2. Trezor Model T, 3. MetaMask, 4. Trust Wallet, 5. Exodus.',
            status: PostStatus.PUBLISHED as PostStatus,
            publishDate: new Date(Date.now() - 432000000), // 5 days ago
            featuredImageUrl: 'https://images.unsplash.com/photo-1639762681057-408e52192e55?w=1200&h=630&fit=crop',
            featuredImageAlt: 'Crypto hardware wallet',
            featuredImageWidth: 1200,
            featuredImageHeight: 630,
            contentType: ContentType.GUIDE,
            difficulty: Difficulty.BEGINNER,
            ...
            readingTime: 6,
            wordCount: 500,
            targetKeyword: 'best crypto wallets',
            categorySlug: 'crypto-security',
        },
        {
            title: 'Stablecoins 101: USDT, USDC, and DAI',
            slug: 'stablecoins-101',
            excerpt: 'Everything you need to know about digital assets pegged to the dollar.',
            content: 'Stablecoins provide a bridge between traditional finance and crypto, offering price stability in a volatile market.',
            status: PostStatus.PUBLISHED as PostStatus,
            publishDate: new Date(Date.now() - 518400000), // 6 days ago
            featuredImageUrl: 'https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=1200&h=630&fit=crop',
            featuredImageAlt: 'Stablecoin representation',
            featuredImageWidth: 1200,
            featuredImageHeight: 630,
            contentType: ContentType.ARTICLE,
            difficulty: Difficulty.BEGINNER,
            ...
            readingTime: 3,
            wordCount: 250,
            targetKeyword: 'stablecoins',
            categorySlug: 'crypto-basics',
        },
        {
            title: 'How to Read a Crypto Candlestick Chart',
            slug: 'read-crypto-charts',
            excerpt: 'A basic introduction to technical analysis for crypto beginners.',
            content: 'Understanding green and red candles is the first step in learning how to trade and time the market.',
            status: PostStatus.PUBLISHED as PostStatus,
            publishDate: new Date(Date.now() - 604800000), // 7 days ago
            featuredImageUrl: 'https://images.unsplash.com/photo-1611974714400-985655768565?w=1200&h=630&fit=crop',
            featuredImageAlt: 'Trading chart',
            featuredImageWidth: 1200,
            featuredImageHeight: 630,
            contentType: ContentType.TUTORIAL,
            difficulty: Difficulty.INTERMEDIATE,
            ...
            readingTime: 7,
            wordCount: 600,
            targetKeyword: 'crypto charts',
            categorySlug: 'investing-and-strategy',
        },
        {
            title: 'Is Solana a "Bitcoin Killer"?',
            slug: 'solana-vs-bitcoin',
            excerpt: 'Comparing speed, decentralization, and use cases between SOL and BTC.',
            content: 'While Solana offers high throughput, Bitcoin remains the king of decentralization and security.',
            status: PostStatus.PUBLISHED as PostStatus,
            publishDate: new Date(Date.now() - 691200000), // 8 days ago
            featuredImageUrl: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=1200&h=630&fit=crop',
            featuredImageAlt: 'Solana vs Bitcoin',
            featuredImageWidth: 1200,
            featuredImageHeight: 630,
            contentType: ContentType.ARTICLE,
            difficulty: Difficulty.INTERMEDIATE,
            ...
            readingTime: 4,
            wordCount: 300,
            targetKeyword: 'solana vs bitcoin',
            categorySlug: 'investing-and-strategy',
        }
    ]
