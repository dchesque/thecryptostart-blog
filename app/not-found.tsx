...
export default async function NotFound() {
  ...
  return (
    <div className="bg-paper">
      <div className="container-hub py-24 md:py-32">
              ...
              {suggestions.map((post) => (
                <li key={post.id}>
                  <Link href={`/blog/${post.slug}`} className="group block">
                    <h3 className="font-heading text-lg font-bold text-ink leading-snug group-hover:text-accent-deep transition-colors line-clamp-2">
                      {post.title}
                    </h3>
